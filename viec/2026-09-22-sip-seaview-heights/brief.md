# Brief — Dự án seaview-heights (Cộng Hòa Síp) — template HTML thuần của theme
...
- Nguồn `template-bds-imm/du-an/sip__seaview-heights/dist/`, **HTML thuần, không phải ACF**.

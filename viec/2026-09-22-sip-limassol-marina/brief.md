# Brief — Dự án limassol-marina (Cộng Hòa Síp) — template HTML thuần của theme
...
- Nguồn `template-bds-imm/du-an/sip__limassol-marina/dist/`, **HTML thuần, không phải ACF**.

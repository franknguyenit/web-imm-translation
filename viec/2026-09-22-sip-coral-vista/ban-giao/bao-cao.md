# Báo cáo — Dự án Coral Vista (Cộng Hòa Síp)

- **Nguồn:** HTML thuần của theme — `template-bds-imm/du-an/sip__coral-vista/dist/sip__coral-vista.html` (**không phải ACF**).
  Trang web: `/quoc-tich-va-thuong-tru-nhan-chau-au/thuong-tru-nhan-cong-hoa-sip-cyprus/dinh-cu-cong-hoa-sip-du-an-khu-biet-thu-coral-vista/`
- **Dự án:** 19 biệt thự đỉnh đồi Peyia, Paphos · giá từ 480.000 EUR.
...
| `seo.json` · `sip-coral-vista.en.json` | SEO · bản ACF-giả nội bộ (**không import**) |

## Từ khoá
- **Chính:** `cyprus real estate investment`. Chi tiết phụ xem `ban-giao/seo.json`.

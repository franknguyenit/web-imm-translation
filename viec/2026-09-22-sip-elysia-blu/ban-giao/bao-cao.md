# Báo cáo — Dự án Elysia Blu (Cộng Hòa Síp)

- **Nguồn:** HTML thuần của theme — `template-bds-imm/du-an/sip__elysia-blu/dist/sip__elysia-blu.html` (**không phải ACF**).
  Trang web: `/quoc-tich-va-thuong-tru-nhan-chau-au/thuong-tru-nhan-cong-hoa-sip-cyprus/dinh-cu-cong-hoa-sip-du-an-can-ho-cao-cap-elysia-blu/`
- **Dự án:** 200 căn hộ, trung tâm Paphos · giá từ 511.000 EUR.
...
| `seo.json` · `sip-elysia-blu.en.json` | SEO · bản ACF-giả nội bộ (**không import**) |

## Từ khoá
- **Chính:** `cyprus golden visa property`. Chi tiết phụ xem `ban-giao/seo.json`.
